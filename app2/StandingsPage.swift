...
//MARK: NEW FUNC -- saves to persistant storage the driver info
func newGetStandings() {
    var queen: Queen = .init(standing: "", pts: "", person: "", abrv: "", histno: "")
    ...
    for i in 0...25 {
        ...
        queen.standing = drivers[i].standing
        queen.pts = drivers[i].pts
        queen.person = drivers[i].person
        queen.abrv = drivers[i].abrv
        queen.histno = drivers[i].histno
...
//MARK: OLD FUNC -- it saves drivers to an array
